...
class Sensors():
	...
	def start(self):
		...
		self.imu = BNO055.BNO055(rst=self.i2c_rst_pin)
	...
	def getMeasure(self):
		""" Return a dictionnary with the last sensors measurement """
...
class Tigrillo():
	...
	def __init__(self, uart_port="/dev/ttyACM0", uart_baud=9600, i2c_rst_pin="P9_12", save_all=True, data_folder=None):
	...
	def updateActuators(self, update):
